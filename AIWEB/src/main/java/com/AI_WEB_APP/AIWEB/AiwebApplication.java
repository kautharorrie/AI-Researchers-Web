	...
	public void run(String... args) throws Exception {
		...
		while (true) {
			...
			//if the user wants to update the file
				...
				while (true) {
					...
					File tempFile = new File(userDirectory
							+ "\\AIWEB\\src\\main\\resources\\Current-Rated-Researchers-" + userDayInput + "-" + userMonthInput + "-" + userYearInput + ".xlsx");
			...
			try {
				...
				FileInputStream file = new FileInputStream(
						new File(userDirectory
								+ "\\AIWEB\\src\\main\\resources\\Current-Rated-Researchers-" + userDay + "-" + userMonth + "-" + userYear + ".xlsx"));
			...
			try {
				...
				FileInputStream file = new FileInputStream(
						new File(userDirectory
								+ "\\AIWEB\\src\\main\\resources\\ResearchPapers.xlsx"));
				XSSFWorkbook workbook = new XSSFWorkbook(file);
				XSSFSheet sheet = workbook.getSheetAt(0);
				Iterator<Row> rowIterator = sheet.iterator();
